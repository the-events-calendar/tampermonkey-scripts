...
//== START ==//
    ...
    if ( typeof alreadydone == 'undefined'  && bodyTag.classList.length >= 0 ) {
        ...
        var pluginHistory = {
            ...
            128: { name: "G22.lattice",     date: "Mar 17",     tec: "5.14.1x",   pro: "5.12.2x",   vev: "1.8.3",    fib: "5.2.1",    ebt: "4.6.10x",eti: "5.3.1",      etp: "5.4.1",     cev: "4.8.12",    ctx: "4.7.10",   apm: "4.5.1",  iwp: "1.0.3",  woo: "6.2.1", edd: "2.11.5" },
        };
