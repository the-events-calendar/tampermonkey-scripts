...
//== START ==//
    ...
    if ( typeof alreadydone == 'undefined'  && bodyTag.classList.length >= 0 ) {
        ...
        var pluginHistory = {
            ...
            133: { name: "B22.lotasaurus",  date: "Apr 28",     tec: "5.14.2.1",  pro: "5.13.1",    vev: "1.9.0",    fib: "5.2.1",    ebt: "4.6.10",  eti: "5.3.3x",     etp: "5.4.3x",    cev: "4.8.13",    ctx: "4.7.10",   apm: "4.5.1",  iwp: "1.0.3",  woo: "6.4.1", edd: "2.11.6" },
        };
